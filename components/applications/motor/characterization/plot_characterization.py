...
class CharacterizationDashboard(ctk.CTk):
    ...
    def _build_ui(self):
        ...
        self.val_tm = ctk.CTkLabel(tm_blk, text="-.---", font=VAL_FONT, text_color=ACCENT_COLOR)
        self.val_tm.pack(anchor="e")

        # BOX 3: PID ESTIMATION
        ...
        self.lbl_kp = ctk.CTkLabel(kp_frame, text="--.---", font=PID_VAL_FONT, text_color=ACCENT_COLOR)
        ...
        self.lbl_ki = ctk.CTkLabel(ki_frame, text="--.---", font=PID_VAL_FONT, text_color=ACCENT_COLOR)
    ...
    def clear_dashboard_labels(self):
        self.val_max_accel.configure(text="--.--")
        self.val_tm.configure(text="-.---")
        self.val_rec_accel.configure(text="--.--")
        self.val_settling.configure(text="-.---")
        self.lbl_kp.configure(text="--.---")
        self.lbl_ki.configure(text="--.---")
        self.eq_display.configure(state="normal")
        self.eq_display.delete("1.0", "end")
        self.eq_display.insert("1.0", "// No active curves...")
        self.eq_display.configure(state="disabled")
    ...
    def update_plots(self, *args):
        ...
        self.ax_time.set_title("Step Responses", color=TEXT_COLOR, fontsize=12, pad=10)
